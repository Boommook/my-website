    ...
    return (
        <div className="shadow-lg w-[85%] md:w-150 h-fit border-2 rounded-xl border-tangerine/30 p-4 bg-lightgray">
             <div className="flex items-start">
                <img src={withBasePath("/images/wpilogo.png")} alt="WPI Logo" className="w-20 mt-2 mr-4 rounded-lg p-2 bg-white hover:cursor-pointer" onClick={() => window.open("https://www.wpi.edu/", "_blank")}/>
                <div>
                    ...
                    <h4 className="text-gray/70 text-sm mb-4">GPA: 3.95/4.0</h4>
                </div>
            </div>
            <div className="space-y-[2%] flex flex-col">
                <div>
                    ...
                    Intro to AI, Linear Algebra, Operating Systems, Discrete Math, Systems Engineering, HCI, Webware, Machine Learning, Database Systems</p>
                </div>
